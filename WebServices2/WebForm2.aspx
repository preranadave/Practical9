...
<body>
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
        ErrorMessage="please enter no1" ControlToValidate="txtno1"></asp:RequiredFieldValidator>
    <div>
    
        <asp:Label ID="Label2" runat="server" Text="No2"></asp:Label>
        <asp:TextBox ID="txtno2" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
            ControlToValidate="txtno2" ErrorMessage="please enter no2"></asp:RequiredFieldValidator>
        <br />
